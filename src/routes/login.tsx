...
import { Eye, EyeOff, Shield, Trophy, Zap } from "lucide-react";
  ...
  const handleSubmit = async (e?: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (isAdmin) {
        ...
        const message = "Admin account байна. Admin login хэсгээр нэвтэрнэ үү.";
        setErrorText(message);
        toast.error(message);
        return;
      }
      ...
      <div className="relative hidden lg:flex flex-col justify-between p-12 overflow-hidden border-r border-border bg-[radial-gradient(circle_at_20%_20%,oklch(0.7_0.18_240/0.18),transparent_60%),radial-gradient(circle_at_80%_80%,oklch(0.65_0.2_280/0.15),transparent_55%)]">
        ...
        <div className="relative space-y-6 max-w-md">
          ...
          <p className="text-muted-foreground text-base leading-relaxed">
            Track quests, gain XP, climb the leaderboard, and unlock achievements as you become a
      ...
      <div className="flex items-center justify-center px-6 py-12 sm:px-12">
        <div className="w-full max-w-md">
          ...
          <div className="glass-panel frame-corner p-8 animate-float-up">
            <p className="text-xs uppercase tracking-[0.4em] text-primary-glow mb-2">
              ▸ System Login
            </p>
