...
import aiAssistantJpg from "@/assets/ai-assistant.jpg";
      ...
      <div className="min-h-screen relative overflow-hidden scroll-smooth">
        ...
        <div className="absolute inset-0 -z-10 pointer-events-none">
          <img
            ...
            alt=""
            aria-hidden="true"
            className="w-full h-[90vh] object-cover opacity-18"
            width={1920}
            height={1280}
          />
        ...
        {/* ── System Alert Banner ── */}
        <div className="relative z-20 border-b border-primary/20 bg-background/85 backdrop-blur-sm">
          <div className="container mx-auto px-6 py-2 flex items-center justify-center gap-3">
            ...
            <p className="system-label text-[10px] text-primary-glow/90">
              ▸ [ SYSTEM ] AWAKENING EVENT DETECTED — AI Hunter Coach v2.0 Now Online
            </p>
            <Link
              to="/register"
        ...
        <section className="relative min-h-[calc(100vh-7.5rem)] container mx-auto px-6 pt-6 lg:pt-8 pb-20 grid lg:grid-cols-[0.92fr_1.08fr] gap-10 lg:gap-4 items-center">
          ...
          <div className="animate-float-up relative z-10 space-y-8 lg:pr-6">
            ...
            <h1 className="text-5xl lg:text-7xl xl:text-8xl font-black leading-[0.92] tracking-tight">
              <span className="text-foreground/90">Train smarter.</span>
              <br />
              <span
              ...
              <br />
              <span className="text-foreground/90">Transform your body.</span>
            </h1>
          ...
          {/* Right — Warrior */}
          <div
            className="relative animate-float-up flex items-center justify-center lg:justify-end lg:scale-[1.08]"
          ...
          >
            ...
            <div className="absolute top-[12%] left-[0%] glass-panel frame-corner px-3 py-3 z-10 hidden sm:flex items-center gap-3 animate-float-gentle">
              <img
                src={brandLogo}
                alt="XuchTrack brand mark"
            ...
            {/* Floating XP card */}
            <div
              className="absolute bottom-[16%] left-[1%] glass-panel frame-corner px-3 py-2.5 z-10 min-w-[170px] animate-float-gentle"
              style={{ animationDelay: "2.4s" }}
            >
              <p className="system-label text-[9px] text-muted-foreground mb-1">
                LVL 99 · 47,820 XP
              </p>
            ...
            <img
              ...
              className="hero-character relative w-full max-w-[820px] lg:max-w-[900px] h-auto"
              width={1024}
              height={1024}
            />
          </div>
        ...
        <section id="system" className="container mx-auto px-6 py-24 scroll-mt-20">
          <div className="text-center max-w-2xl mx-auto mb-14 reveal-hidden">
            ...
            <p className="text-muted-foreground">
              Every stat, every quest, every milestone — displayed in your personal Hunter
              dashboard.
            </p>
          </div>
          <div className="relative">
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className="text-muted-foreground mb-6">
                    ...
                    adapts the next session based on today's performance data.
                  </p>
                ...
                <div className="relative">
                  ...
                  <img
                    ...
                    className="relative w-full h-auto hex-cut"
                    loading="lazy"
                    width={768}
                    height={1024}
                  />
            ...
            {[
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    <p className="system-label text-[9px] text-muted-foreground">
                      HUNTER ID: {t.id}
                    </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="reveal-hidden">
              ...
              <p className="text-muted-foreground mb-8">
                No bloat. No noise. Just the tools that move the needle — wrapped in an interface
                that feels effortless on every device.
              </p>
        ...
        <footer className="border-t border-primary/15 mt-8">
          <div className="container mx-auto px-6 py-12 grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="system-label text-[9px] text-primary-glow/50 mt-2">
                HUNTER SYSTEM v2.0
              </p>
            </div>
            <div>
